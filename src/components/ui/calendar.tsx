  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn(
          "flex-1 rounded-(--cell-radius) text-control font-normal text-muted-foreground select-none",
        ...
        week_number: cn(
          "text-control text-muted-foreground select-none",
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        // ponytail: v4 `rounded-(...)` covers all four corners, so the per-corner `-l`/`-r` data-[range-{start,end}=true]: re-targets were dead. Restore them only if range endpoints ever need asymmetric rounding.
